...
st.set_page_config(page_title="Trading Data", page_icon="td_logo.svg", layout="wide", initial_sidebar_state="collapsed")
...
if not st.session_state.authenticated:
  ...
  .stApp {
    .stApp {
        background: #070b14;
        background-image: url('https://images.unsplash.com/photo-1592198084033-aade902d1aae?w=1600&auto=format&fit=crop');
